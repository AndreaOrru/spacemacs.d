...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(zig-mode)
   ;; A list of packages that cannot be updated.
   dotspacemacs-frozen-packages '()
   ;; A list of packages that will not be installed and loaded.
   dotspacemacs-excluded-packages '(auto-yasnippet yasnippet)
...
you should place your code here."
  ...
  (global-subword-mode t)  ;; CamelCase.
  (global-evil-mc-mode t)  ;; Multiple cursors.
  (setq ivy-initial-inputs-alist nil)  ;; No initial ^ in Ivy.
